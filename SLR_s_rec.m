...
%%%% recommendation
[TestRecTopNMatrix, TestRecTopNMatrixValue, TestIndex] = RecMatrix(TestInput, W_rec_p,seed,RecTopN);

% recommend only SLIM Wp
AllRectMatrixPrdTopN_Wp = { TestRecTopNMatrix };

%%%% recommendation
[TestRecTopNMatrix, TestRecTopNMatrixValue, TestIndex] = RecMatrix(TestInput, W_rec_n,seed,RecTopN);

% recommend only SLIM Wn
AllRectMatrixPrdTopN_Wn = { TestRecTopNMatrix };
